<?php
    include_once('config.php');
        ...
        $sql = "SELECT * FROM formulario.fornecedor ORDER BY id DESC";
...
<body>
    <header class="site-header sticky-top py-1">
        <nav class="container d-flex flex-column flex-md-row justify-content-between">
          ...
          <a class="btn btn-secondary" href="relatorio_os.php">Relatórios</a>
          <a class="btn btn-secondary" href="#">Perfil</a>
          <a class="btn btn-secondary" href="view.financeiro.php">Voltar</a>
        </nav>
      </header>
