<?php
    ...
    if(isset($_POST['executar'])){
        ...
        $result = mysqli_query($conexao, "INSERT INTO formulario.relatorio(Nº_OS, id_cliente, cliente, cnpj, telefone, endereco, bairro, cidade, cep, servico, responsavel, descricao,valor, data_emissao, status_os)
        VALUES('$num', '$id_cliente', '$razao_social', '$cnpj', ' $telefone', ' $endereco', ' $bairro', ' $cidade', ' $cep',' $servico', '$responsavel', '$descricao', '$valor', '$data_emissao', '$status_os')");

        header('Location: executar-os.php');
    }
...
<body>
    <div class="container">
        ...
        <form action="dadosOS.php" method="POST">
            ...
            <br><br>
            <div class="status">
                <input type="radio" name=" status_os" id=" exe" value="Em Execução">
                <label class="form-check-label" for=" exe">Executar</label>

                <input type="radio" name=" status_os" id=" feito" value="Finalizada">
        ...
        <br><br><br>
        <button id="executar" name="executar" type="submit">Feito</button>
        <br><br><br>
        </form>
